...
#include "graphnav_msgs/msg/detail/uuid__rosidl_typesupport_fastrtps_c.h"
...
using _UUID__ros_msg_type = graphnav_msgs__msg__UUID;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = graphnav_msgs__msg__UUID;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const graphnav_msgs__msg__UUID * ros_message = static_cast<const graphnav_msgs__msg__UUID *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_graphnav_msgs__msg__UUID(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  graphnav_msgs__msg__UUID * ros_message = static_cast<graphnav_msgs__msg__UUID *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_graphnav_msgs__msg__UUID(cdr, ros_message);
}

static uint32_t _UUID__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_graphnav_msgs__msg__UUID(
...
static size_t _UUID__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_graphnav_msgs__msg__UUID(
