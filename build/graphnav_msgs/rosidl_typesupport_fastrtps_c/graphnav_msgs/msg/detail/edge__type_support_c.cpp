...
#include "graphnav_msgs/msg/detail/edge__rosidl_typesupport_fastrtps_c.h"
...
#include "graphnav_msgs/msg/detail/edge_traversability__functions.h"  // traversability
...
using _Edge__ros_msg_type = graphnav_msgs__msg__Edge;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: to_idx
  {
    cdr << ros_message->to_idx;
  }

  // Field name: from_idx
  {
    cdr << ros_message->from_idx;
  }
  ...
  // Field name: traversability
  {
    ...
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_graphnav_msgs__msg__EdgeTraversability(
        &array_ptr[i], cdr);
    }
  }
  ...
  graphnav_msgs__msg__Edge * ros_message)
{
  ...
  // Field name: traversability
  {
    ...
    if (ros_message->traversability.data) {
      graphnav_msgs__msg__EdgeTraversability__Sequence__fini(&ros_message->traversability);
    }
    ...
    auto array_ptr = ros_message->traversability.data;
    for (size_t i = 0; i < size; ++i) {
      cdr_deserialize_graphnav_msgs__msg__EdgeTraversability(cdr, &array_ptr[i]);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: to_idx
  {
    size_t item_size = sizeof(ros_message->to_idx);
  ...
  // Field name: from_idx
  {
    size_t item_size = sizeof(ros_message->from_idx);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  ...
  // Field name: traversability
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_graphnav_msgs__msg__EdgeTraversability(
  ...
  size_t current_alignment)
{
  ...
  // Field name: traversability
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_graphnav_msgs__msg__EdgeTraversability(
  ...
  if (is_plain) {
    ...
    using DataType = graphnav_msgs__msg__Edge;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: traversability
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_key_graphnav_msgs__msg__EdgeTraversability(
        &array_ptr[i], cdr);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: traversability
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_key_graphnav_msgs__msg__EdgeTraversability(
        &array_ptr[index], current_alignment);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: traversability
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_graphnav_msgs__msg__EdgeTraversability(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const graphnav_msgs__msg__Edge * ros_message = static_cast<const graphnav_msgs__msg__Edge *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_graphnav_msgs__msg__Edge(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  graphnav_msgs__msg__Edge * ros_message = static_cast<graphnav_msgs__msg__Edge *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_graphnav_msgs__msg__Edge(cdr, ros_message);
}

static uint32_t _Edge__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_graphnav_msgs__msg__Edge(
...
static size_t _Edge__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_graphnav_msgs__msg__Edge(
