...
#include "graphnav_msgs/msg/detail/node_traversability_properties__rosidl_typesupport_fastrtps_c.h"
...
#include "geometry_msgs/msg/detail/point__functions.h"  // frontier_points
...
using _NodeTraversabilityProperties__ros_msg_type = graphnav_msgs__msg__NodeTraversabilityProperties;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: frontier_points
  {
    size_t size = ros_message->frontier_points.size;
    auto array_ptr = ros_message->frontier_points.data;
  ...
  // Field name: explored_radius
  {
    cdr << ros_message->explored_radius;
  }

  // Field name: free_radius
  {
  ...
  graphnav_msgs__msg__NodeTraversabilityProperties * ros_message)
{
  ...
  // Field name: frontier_points
  {
    ...
    if (ros_message->frontier_points.data) {
      geometry_msgs__msg__Point__Sequence__fini(&ros_message->frontier_points);
    }
    if (!geometry_msgs__msg__Point__Sequence__init(&ros_message->frontier_points, size)) {
      fprintf(stderr, "failed to create array for field 'frontier_points'");
      return false;
    }
    auto array_ptr = ros_message->frontier_points.data;
    for (size_t i = 0; i < size; ++i) {
...
size_t get_serialized_size_graphnav_msgs__msg__NodeTraversabilityProperties(
  ...
  size_t current_alignment)
{
  const _NodeTraversabilityProperties__ros_msg_type * ros_message = static_cast<const _NodeTraversabilityProperties__ros_msg_type *>(untyped_ros_message);
  (void)ros_message;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = graphnav_msgs__msg__NodeTraversabilityProperties;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const graphnav_msgs__msg__NodeTraversabilityProperties * ros_message = static_cast<const graphnav_msgs__msg__NodeTraversabilityProperties *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_graphnav_msgs__msg__NodeTraversabilityProperties(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  graphnav_msgs__msg__NodeTraversabilityProperties * ros_message = static_cast<graphnav_msgs__msg__NodeTraversabilityProperties *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_graphnav_msgs__msg__NodeTraversabilityProperties(cdr, ros_message);
}

static uint32_t _NodeTraversabilityProperties__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_graphnav_msgs__msg__NodeTraversabilityProperties(
...
static size_t _NodeTraversabilityProperties__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_graphnav_msgs__msg__NodeTraversabilityProperties(
...
static message_type_support_callbacks_t __callbacks_NodeTraversabilityProperties = {
  "graphnav_msgs::msg",
...
static rosidl_message_type_support_t _NodeTraversabilityProperties__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_NodeTraversabilityProperties,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, graphnav_msgs, msg, NodeTraversabilityProperties)() {
  return &_NodeTraversabilityProperties__type_support;
}
