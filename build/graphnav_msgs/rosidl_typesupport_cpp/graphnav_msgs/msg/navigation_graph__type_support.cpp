...
static const _NavigationGraph_type_support_symbol_names_t _NavigationGraph_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, graphnav_msgs, msg, NavigationGraph)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, graphnav_msgs, msg, NavigationGraph)),
  }
};
...
{
  return &::graphnav_msgs::msg::rosidl_typesupport_cpp::NavigationGraph_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, graphnav_msgs, msg, NavigationGraph)() {
  return get_message_type_support_handle<graphnav_msgs::msg::NavigationGraph>();
}
