...
class Metaclass_Edge(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if EdgeTraversability.__class__._TYPE_SUPPORT is None:
                EdgeTraversability.__class__.__import_type_support__()
...
class Edge(metaclass=Metaclass_Edge):
    ...
    _fields_and_field_types = {
        'to_idx': 'uint32',
        'from_idx': 'uint32',
        'traversability': 'sequence<graphnav_msgs/EdgeTraversability>',
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BasicType('uint32'),  # noqa: E501
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['graphnav_msgs', 'msg'], 'EdgeTraversability')),  # noqa: E501
    ...
    def __init__(self, **kwargs):
        ...
        self.to_idx = kwargs.get('to_idx', int())
        self.from_idx = kwargs.get('from_idx', int())
        self.traversability = kwargs.get('traversability', [])
    ...
    def __eq__(self, other):
        if not isinstance(other, self.__class__):
            return False
        if self.to_idx != other.to_idx:
            return False
        if self.from_idx != other.from_idx:
            return False
    ...
    @builtins.property
    def to_idx(self):
        """Message field 'to_idx'."""
        return self._to_idx

    @to_idx.setter
    def to_idx(self, value):
        if self._check_fields:
            assert \
                isinstance(value, int), \
                "The 'to_idx' field must be of type 'int'"
            assert value >= 0 and value < 4294967296, \
                "The 'to_idx' field must be an unsigned integer in [0, 4294967295]"
        self._to_idx = value

    @builtins.property
    def from_idx(self):
        """Message field 'from_idx'."""
        return self._from_idx

    @from_idx.setter
    def from_idx(self, value):
        if self._check_fields:
            assert \
                isinstance(value, int), \
                "The 'from_idx' field must be of type 'int'"
            assert value >= 0 and value < 4294967296, \
                "The 'from_idx' field must be an unsigned integer in [0, 4294967295]"
        self._from_idx = value
        ...
        if self._check_fields:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 all(isinstance(v, EdgeTraversability) for v in value) and
                 True), \
                "The 'traversability' field must be a set or sequence and each value of type 'EdgeTraversability'"
