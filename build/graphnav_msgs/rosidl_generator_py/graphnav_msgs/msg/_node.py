...
class Metaclass_Node(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if NodeTraversabilityProperties.__class__._TYPE_SUPPORT is None:
                NodeTraversabilityProperties.__class__.__import_type_support__()
...
class Node(metaclass=Metaclass_Node):
    ...
    _fields_and_field_types = {
        'uuid': 'graphnav_msgs/UUID',
        'pose': 'geometry_msgs/Pose',
        'trav_properties': 'sequence<graphnav_msgs/NodeTraversabilityProperties>',
    ...
    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['graphnav_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['geometry_msgs', 'msg'], 'Pose'),  # noqa: E501
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['graphnav_msgs', 'msg'], 'NodeTraversabilityProperties')),  # noqa: E501
    ...
    def __init__(self, **kwargs):
        ...
        self.trav_properties = kwargs.get('trav_properties', [])
    ...
    def __eq__(self, other):
        ...
        if self.pose != other.pose:
            return False
        if self.trav_properties != other.trav_properties:
            return False
    ...
    @builtins.property
    def trav_properties(self):
        """Message field 'trav_properties'."""
        return self._trav_properties

    @trav_properties.setter
    def trav_properties(self, value):
        if self._check_fields:
            from graphnav_msgs.msg import NodeTraversabilityProperties
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 all(isinstance(v, NodeTraversabilityProperties) for v in value) and
                 True), \
                "The 'trav_properties' field must be a set or sequence and each value of type 'NodeTraversabilityProperties'"
        self._trav_properties = value
