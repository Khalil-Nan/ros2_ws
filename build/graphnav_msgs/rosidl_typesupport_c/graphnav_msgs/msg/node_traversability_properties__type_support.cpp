...
static const _NodeTraversabilityProperties_type_support_symbol_names_t _NodeTraversabilityProperties_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, graphnav_msgs, msg, NodeTraversabilityProperties)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, graphnav_msgs, msg, NodeTraversabilityProperties)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, graphnav_msgs, msg, NodeTraversabilityProperties)() {
  return &::graphnav_msgs::msg::rosidl_typesupport_c::NodeTraversabilityProperties_message_type_support_handle;
}
