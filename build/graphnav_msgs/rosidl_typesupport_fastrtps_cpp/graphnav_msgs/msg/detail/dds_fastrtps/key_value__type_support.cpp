...
#include "graphnav_msgs/msg/detail/key_value__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = graphnav_msgs::msg::KeyValue;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const graphnav_msgs::msg::KeyValue *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<graphnav_msgs::msg::KeyValue *>(
    untyped_ros_message);
...
{
  return &graphnav_msgs::msg::typesupport_fastrtps_cpp::_KeyValue__handle;
}
