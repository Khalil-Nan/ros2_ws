...
#include "graphnav_msgs/msg/detail/edge_traversability__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const graphnav_msgs::msg::EdgeTraversability & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  graphnav_msgs::msg::EdgeTraversability & ros_message)
{
  // Member: traversability_cost
  cdr >> ros_message.traversability_cost;
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_graphnav_msgs
max_serialized_size_EdgeTraversability(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = graphnav_msgs::msg::EdgeTraversability;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_graphnav_msgs
max_serialized_size_key_EdgeTraversability(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const graphnav_msgs::msg::EdgeTraversability *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<graphnav_msgs::msg::EdgeTraversability *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _EdgeTraversability__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const graphnav_msgs::msg::EdgeTraversability *>(
...
static size_t _EdgeTraversability__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_EdgeTraversability(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _EdgeTraversability__callbacks = {
  "graphnav_msgs::msg",
  "EdgeTraversability",
...
static rosidl_message_type_support_t _EdgeTraversability__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_EdgeTraversability__callbacks,
...
{
  return &graphnav_msgs::msg::typesupport_fastrtps_cpp::_EdgeTraversability__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, graphnav_msgs, msg, EdgeTraversability)() {
  return &graphnav_msgs::msg::typesupport_fastrtps_cpp::_EdgeTraversability__handle;
}
