...
#include "graphnav_msgs/msg/detail/edge__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const graphnav_msgs::msg::EdgeTraversability &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  graphnav_msgs::msg::EdgeTraversability &);
...
cdr_serialize(
  const graphnav_msgs::msg::Edge & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  graphnav_msgs::msg::Edge & ros_message)
{
  // Member: to_idx
  cdr >> ros_message.to_idx;
  ...
  // Member: traversability
  {
    ...
    ros_message.traversability.resize(size);
    for (size_t i = 0; i < size; i++) {
      graphnav_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
        cdr, ros_message.traversability[i]);
    }
  }
  ...
  // Member: traversability
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        ...
        ros_message.traversability[index], current_alignment);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: traversability
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        graphnav_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_EdgeTraversability(
  ...
  if (is_plain) {
    ...
    using DataType = graphnav_msgs::msg::Edge;
    is_plain =
      (
  ...
  size_t current_alignment)
{
  ...
  // Member: traversability
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        graphnav_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_key_EdgeTraversability(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const graphnav_msgs::msg::Edge *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<graphnav_msgs::msg::Edge *>(
    untyped_ros_message);
...
{
  return &graphnav_msgs::msg::typesupport_fastrtps_cpp::_Edge__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, graphnav_msgs, msg, Edge)() {
  return &graphnav_msgs::msg::typesupport_fastrtps_cpp::_Edge__handle;
}
