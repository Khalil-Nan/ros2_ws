...
#include "graphnav_msgs/msg/detail/uuid__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const graphnav_msgs::msg::UUID & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  graphnav_msgs::msg::UUID & ros_message)
{
  // Member: id
  {
    cdr >> ros_message.id;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = graphnav_msgs::msg::UUID;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const graphnav_msgs::msg::UUID *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<graphnav_msgs::msg::UUID *>(
    untyped_ros_message);
...
{
  return &graphnav_msgs::msg::typesupport_fastrtps_cpp::_UUID__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, graphnav_msgs, msg, UUID)() {
  return &graphnav_msgs::msg::typesupport_fastrtps_cpp::_UUID__handle;
}
