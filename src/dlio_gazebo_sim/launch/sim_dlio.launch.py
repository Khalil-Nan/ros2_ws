...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument('go2_camera_x', default_value='0.16837'),
        DeclareLaunchArgument('go2_camera_y', default_value='0.0'),
        DeclareLaunchArgument('go2_camera_z', default_value='-0.02'),
        ...
        DeclareLaunchArgument('initial_goal_y', default_value='100.0'),
