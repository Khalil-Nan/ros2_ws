...
def generate_launch_description():
    ...
    ld.add_action(
        DeclareLaunchArgument(
            ...
            description='Full path to the ROS2 parameters file to use for launched Nav2 nodes',
        )
    )
    ld.add_action(
        DeclareLaunchArgument(
    ...
    ld.add_action(
        DeclareLaunchArgument(
            'use_composition',
            default_value='False',
            description='Composition is accepted for compatibility but not used by this launch file.',
        )
    )
    ld.add_action(
        DeclareLaunchArgument(
